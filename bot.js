...
var statusFlag = 0;
const captureCompare = [/^\Nico$/, /^\nico$/, /^\\roll d20$/, /^\/roll d20$/, /^\\reg$/, /^\\status$/, /^\@Eric$/, /^\Prepare for trouble$/, /^\Josh$/, /^\Coolest$/, /^\coolest$/, /^\Happy New Year!$/, /^\Raphtalia$/];
const responseGrid = ["I like rocks XD", "I like rocks XD", "roll", "roll", regID, "status", "@God_damn", "And make it double", "Josh-Sama!", "God-Damn-Coolest-O", "God-Damn-Coolest-O", "Reminder: Happy God Damn New Year!", "NAOFUMI-SAMA!"];
